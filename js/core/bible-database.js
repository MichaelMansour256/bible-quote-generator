...
const bibleDatabase = {
    books: [
        { id: 'genesis', name: 'تكوين', chapters: 50 },
        { id: 'exodus', name: 'خروج', chapters: 40 },
        { id: 'leviticus', name: 'لاويين', chapters: 27 },
        { id: 'numbers', name: 'عدد', chapters: 36 },
        { id: 'deuteronomy', name: 'تثنية', chapters: 34 },
        { id: 'joshua', name: 'يشوع', chapters: 24 },
        { id: 'judges', name: 'القضاة', chapters: 21 },
        { id: 'ruth', name: 'راعوث', chapters: 4 },
        { id: '1-samuel', name: '1 صموئيل', chapters: 31 },
        { id: '2-samuel', name: '2 صموئيل', chapters: 24 },
        { id: '1-kings', name: '1 الملوك', chapters: 22 },
        { id: '2-kings', name: '2 الملوك', chapters: 25 },
        { id: '1-chronicles', name: '1 أخبار الأيام', chapters: 29 },
        { id: '2-chronicles', name: '2 أخبار الأيام', chapters: 36 },
        ...
        { id: 'ecclesiastes', name: 'الجامعة', chapters: 12 },
        ...
        { id: '1-corinthians', name: '1 كورنثوس', chapters: 16 },
        { id: '2-corinthians', name: '2 كورنثوس', chapters: 13 },
        { id: 'galatians', name: 'غلاطية', chapters: 6 },
        { id: 'ephesians', name: 'أفسس', chapters: 6 },
        { id: 'philippians', name: 'فيليبي', chapters: 4 },
        { id: 'colossians', name: 'كولوسي', chapters: 4 },
        { id: '1-thessalonians', name: '1 تسالونيكي', chapters: 5 },
        { id: '2-thessalonians', name: '2 تسالونيكي', chapters: 3 },
        { id: '1-timothy', name: '1 تيموثاوس', chapters: 6 },
        { id: '2-timothy', name: '2 تيموثاوس', chapters: 4 },
        { id: 'titus', name: 'تيطس', chapters: 3 },
        { id: 'philemon', name: 'فليمون', chapters: 1 },
        { id: 'hebrews', name: 'عبرانيين', chapters: 13 },
        { id: 'james', name: 'يعقوب', chapters: 5 },
        { id: '1-peter', name: '1 بطرس', chapters: 5 },
        { id: '2-peter', name: '2 بطرس', chapters: 3 },
        { id: '1-john', name: '1 يوحنا', chapters: 5 },
        { id: '2-john', name: '2 يوحنا', chapters: 1 },
        { id: '3-john', name: '3 يوحنا', chapters: 1 },
        { id: 'jude', name: 'يهوذا', chapters: 1 },
        { id: 'revelation', name: 'الرؤيا', chapters: 22 }
    ],
