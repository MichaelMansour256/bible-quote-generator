const TRANSLATIONS = {
    ar: {
        ...
        'whoami-desc':          'اقرأ التلميح ثم اضغط على البطاقة لكشف اسم الشخصية.',
        'whoami-score-label':   'الدرجة',
        'whoami-stat-count':    'عدد البطاقات',
        'whoami-stat-revealed': 'المكتشفة',
        'btn-whoami-start':     'ابدأ اللعبة',
        'btn-new-card':         'بطاقة جديدة',
        'whoami-status':        'اضغط على البدء للحصول على بطاقة تلميح.',
    ...
    en: {
        ...
        'whoami-desc':          'Read the clue, then click the flash card to reveal the person\'s name.',
        'whoami-score-label':   'Score',
        'whoami-stat-count':    'Cards',
        'whoami-stat-revealed': 'Revealed',
        'btn-whoami-start':     'Start Game',
        'btn-new-card':         'New Card',
        'whoami-status':        'Press start to get a clue card.',
