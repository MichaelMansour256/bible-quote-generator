const TRANSLATIONS = {
    ar: {
        ...
        'wordle-len-6':         '6 حروف',
        'wordle-len-7':         '7 حروف',
        'btn-wordle-start':     'ابدأ هولي ووردل',
        'wordle-status':        'اضغط على البدء لاختيار كلمة سرية من الكتاب.',
        ...
        'btn-whoami-start':     'ابدأ اللعبة',
        'btn-new-card':         'بطاقة جديدة',
        'whoami-status':        'اضغط على البدء، ثم اقرأ التلميح وقلّب البطاقة وحدّد: هل عرفتها؟',
        'label-whoami-clue':    'التلميح - من أنا؟',
        'whoami-tap-hint':      'اضغط على البطاقة لكشف الاسم 👆',
        ...
        'btn-emojiverse-start':     'ابدأ اللعبة',
        'emojiverse-status':        'اضغط على البدء، ثم اقرأ الإيموجي وقلّب البطاقة وحدّد: هل عرفتها؟',
        'label-emojiverse-clue':    'التلميح - ما القصة؟',
        'emojiverse-q':             '؟ ما القصة',
        'emojiverse-tap-hint':      'اضغط على البطاقة لكشف الإجابة 👆',
    ...
    en: {
        ...
        'btn-wordle-start':     'Start HolyWordle',
        'wordle-status':        'Press start to pick a secret Bible word.',
        ...
        'btn-whoami-start':     'Start Game',
        'btn-new-card':         'New Card',
        'whoami-status':        'Press start, read the clue, flip the card, then grade yourself.',
        'label-whoami-clue':    'Clue — Who am I?',
        'whoami-tap-hint':      'Click the card to reveal the name 👆',
        ...
        'btn-emojiverse-start':     'Start Game',
        'emojiverse-status':        'Press start, decode the emojis, flip the card, then grade yourself.',
        'label-emojiverse-clue':    'Clue — what story is it?',
        'emojiverse-q':             'What is it?',
        'emojiverse-tap-hint':      'Click the card to reveal the answer 👆',
