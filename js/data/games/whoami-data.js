// "Who Am I?" (من أنا؟) — game data: per-difficulty card pools and the
// level map. Content only; game logic lives in whoami-game.js.

// ============================================================
//   Level 1 — سهل (Easy)
// ============================================================
export const WHOAMI_EASY_POOL = [
...
// ============================================================
export const WHOAMI_MEDIUM_POOL = [
...
// ============================================================
export const WHOAMI_DEFAULT_POOL = [
    ...WHOAMI_EASY_POOL,
    ...WHOAMI_MEDIUM_POOL,
    ...WHOAMI_HARD_POOL
];
...
export const WHOAMI_LEVEL_TO_ARABIC = {
    easy: 'سهل',
    medium: 'متوسط',
    hard: 'صعب'
};
